...
const calculInput = document.getElementById('calculInputCurrent');
const previousNumberText = document.getElementById('calculInputPrevious');
...
for (let i = 0; i < operatorButtons.length; i++) {
    operatorButtons[i].addEventListener('click', choseOperation);
}
...
for (let i = 0; i < numberButtons.length; i++) {
    numberButtons[i].addEventListener('click', onButtonNumberClick);
}
